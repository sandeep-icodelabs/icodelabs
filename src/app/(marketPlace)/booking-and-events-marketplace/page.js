...
const heroData = {
  title: "Seamless Booking Experiences for Events, Classes & More",
  content: `Whether you're launching events, education, or experiences—we deliver booking platforms with precision scheduling, video calls, and calendar sync.`,
  btnLink: "",
  btnText: "Get a Quote",
};

const whatIsRental = {
  title: "What is a Booking & Events Marketplace?",
  para: `Platforms focused on time-bound services, where users discover, book, and attend events or classes in real time.`,
...
const keyFeatureData = [
  ...
  {
    title: "Instant or Request-Based Booking",
    description:
      "An intriguing aspect of digital marketing is technical optimization, which",
    color: "green",
    img: "/assests/img/blank.png",
